...
write_csv(rf_preds, file="predictions34.csv")
```
...
trainm = sparse.model.matrix(price~., data = df_train)

# Define the labels
train_label = df_train[, "price"]


# Create the training dataset for LightGBM
...
predictions = predict(model_lgb, as.matrix(trainm))
